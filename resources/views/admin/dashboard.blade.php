...
<nav class="sidebar">
    <div class="user-info" style="display:inline-flex;margin:10px 10px 10px 10px">
            <div class="profile" style="padding: 60px 60px 60px 45px;">
...
<br>
<div class="parent_card" style="margin-left:80px;">
...
<div class="intro" style="margin-left:100px;">
    ...
    <div class="profile_section">
      ...
      <img src="{{ asset('image/small size.jpg') }}" alt="">
      <div class="name">Koulick Ghosh</div>
      <div class="roll">Roll : 15201220036</div>
      <div class="section">Session : 2020-2023</div>
...
<div class="intro" style="margin-left:50px;">
    ...
    <div class="profile_section">
      ...
      <img src="{{ asset('image/arka.png') }}" alt="">
      <div class="name">Arka Prabha Majumder</div>
      <div class="roll">Roll : 15201220138</div>
      <div class="section">Session : 2020-2023</div>
...
<div class="parent_card" style="margin-left:150px;">
...
<div class="intro" style="margin-left:50px;">
    ...
    <div class="profile_section" >
      ...
      <img src="{{ asset('image/sujit.jpg') }}" alt="">
      <div class="name">Sujit Bisoi</div>
      <div class="roll">Roll : 15201220058</div>
      <div class="section">Session : 2020-2023</div>
...
<div class="intro" style="margin-left:60px;">
    ...
    <div class="profile_section">
      ...
      <img src="{{ asset('image/swap.jpg') }}" alt="">
      <div class="name">Swapnadeep Kundu</div>
      <div class="roll">Roll : 15201220009</div>
      <div class="section">Session : 2020-2023</div>
